...
struct SPAVFrameRendererView: CPViewRepresent {
    ...
    func makeView(context: Context) -> MTKView {
        ...
        context.coordinator.renderer = MetalAVFrameRenderer(mtkView: mtkView)
...
//        view.draw()
    ...
    class Coordinator {
        var renderer: MetalAVFrameRenderer?
    }
}
